                    ...
                    <tbody>
                        <c:forEach var="item" items="${lr}">
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-danger btna" data-toggle="modal"  data-id="/AdminKMA/deletePhongBan?id=${item.idRoom}"  data-target="#exampleModalCenter">
                                        <i class="far fa-trash-alt"></i>
                                    </button></td>


                                <td> <a class="btn btn-primary" href="/AdminKMA/updatePhongBan?&id=${item.idRoom}"><i class="fas fa-user-edit"></i></a></td>
