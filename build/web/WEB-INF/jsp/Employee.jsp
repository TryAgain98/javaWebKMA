                    ...
                    <tbody>
                        <c:forEach var="item" items="${lep}">
                            <tr>
                                ...
                                <td>${item.fullName}</td>
                                <td>${item.positionn}</td>
                                <td>${item.phone}</td>
                                <td>${item.birthday}</td>
                                <td>${item.name}</td>
                               <td><button type="button" class="btn btn-danger btna" data-toggle="modal"  data-id="/AdminKMA/deleteEmployee?idRFID=${item.idRFID}&idFingerprint=${item.idFingerprint}"  data-target="#exampleModalCenter">
                                        <i class="far fa-trash-alt"></i>
                                    </button></td>
                
                                <td> <a class="btn btn-primary" href="/AdminKMA/updateEmployee?idRFID=${item.idRFID}&idFingerprint=${item.idFingerprint}"><i class="fas fa-user-edit"></i></a></td>
