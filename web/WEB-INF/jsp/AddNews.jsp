...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="content">
                <h4 class="tittleForm" >Thêm Tin Tức</h4>
                  <spring:form  action="/AdminKMA/saveAddNews" method="post"  modelAttribute="tn" >
               
                <div class="form-group">
                    <label for="exampleFormControlInput1" class="TittleChildren">Tiêu đề</label>
                    <spring:input type="text" path="tittle" class="form-control" id="exampleFormControlInput1" placeholder="Tiêu đề bài viết"/>
                </div>
