                    ...
                    <tbody>
                        <c:forEach var="item" items="${ln}">
                            <tr>
                                ...
                                <td>${item.tinHot}</td>
                                <td><button type="button" class="btn btn-danger btna" data-toggle="modal"  data-id="/AdminKMA/deleteTittleNews?id=${item.idTN}"  data-target="#exampleModalCenter">
                                        <i class="far fa-trash-alt"></i>
                                    </button></td>


                                <td> <a class="btn btn-primary" href="/AdminKMA/updateTittleNews?&id=${item.idTN}"><i class="fas fa-user-edit"></i></a></td>
                                <td> <a class="btn btn-info" href="/AdminKMA/contentNews?&id=${item.idTN}">Nội dung</a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
